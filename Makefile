...
PORT = usb
TARGET = $(BINDIR)/chapeau_lumineux
MCU = attiny85
...
#ASFLAGS = -Wa,-adhlns=$(<:.S=.lst),-gstabs $(INCFLAGS) $(DEFS)
...
AVRDUDE_WRITE_FLASH += -U lfuse:w:0xe2:m -U hfuse:w:0xde:m -U efuse:w:0xff:m #datasheet p148
